...
def main(argv):
    ...
    for path in [newtargetVesselsPathTest, newtargetVesselsPathTrain]: #newtargetVeinsPathTest, newtargetVeinsPathTrain, newtargetArteriesPathTest, newtargetArteriesPathTrain]:
        for item in os.listdir(path):
